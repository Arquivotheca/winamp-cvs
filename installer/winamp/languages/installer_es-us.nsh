...
; CodePage:			1252
; Revision:			7 UNICODE
; Last udpdated:	13.03.2011
; Author: Darwin Toledo aka niwrad
; Email:niwrad777@niwradsoft.com
; Base: Manuel Gutiérrez
...
${LangFileString} installStandart "Estándar"
...
${LangFileString} installerContainsBundle "Este instalador contiene la instalación completa y agregados."
${LangFileString} installerContainsPro "Este instalador contiene la instalación profesional."
${LangFileString} installerContainsFull "Este instalador contiene la instalación completa."
${LangFileString} installerContainsStandard "Este instalador contiene la instalación estándar."
...
${LangFileString} verHistHeader "Historial de versiones"
${LangFileString} verHistHeaderSub "Historial de versiones de Winamp"
${LangFileString} verHistTop "Revise los cambios de la versión antes de continuar:"
${LangFileString} verHistBottom "Las actualizaciones marcadas en rojo requieren una atención especial."
${LangFileString} verHistButton "Terminar"
...
${LangFileString} whatNew "Novedades"
...
${LangFileString} secSonicBurning "Compatibilidad con la grabación y extracción de Sonic"
...
${LangFileString} secDVD "Reproducción de DVD (se requiere un decodificador de DVD de terceros)"

!ifdef eMusic-7plus
  ${LangFileString} secEMusic "Icono de eMusic y oferta de 50 MP3 gratuitos."
!endif
!ifdef musicNow
  ${LangFileString} secMusicNow "Icono de AOL Music Now y oferta de versión de prueba gratuita durante 30 días."
!endif
!ifdef BUNDLE_AVS
  ${LangFileString} secBundleAVS "Consiga protección antivirus gratuita con Active Virus Shield."
!endif
!ifdef BUNDLE_ASM
  ${LangFileString} secBundleASM "Consiga Active Security Monitor. ¡ES GRATIS!"
!endif
...
${LangFileString} secOrb "Multimedia Remota"
...
${LangFileString} sec_ML_DASH "Panel de Control de Winamp"
...
${LangFileString} IDS_SEC_GEN_DROPBOX		"Winamp DropBox (Versión Alfa)"
;${LangFileString} IDS_SEC_ML_ORGLER		"Winamp Orgler™"
${LangFileString} IDS_SEC_ML_ADDONS		"Agregados de Winamp"
...
${LangFileString} IDS_RUN_OPTIMIZING			"Optimizando..."
...
${LangFileString} IDS_PAGE_WELCOME_TEXT		"$(^NameDA) le permite escuchar, ver y administrar música, videos, podcasts y radio por Internet.$\r$\n$\r$\nLas características incluyen:$\r$\n$\r$\n  \
													•  Sincronizar de forma inalámbrica, medios a la aplicación$\r$\n      \
                                                                                                        $(^NameDA) para Android.$\r$\n  \
													•  Controlar la reproducción, desde el navegador con$\r$\n      \
													   Winamp Toolbar.$\r$\n  \
													•  Limpiar medios de metadatos, con la función de$\r$\n      \
                                                                                                        etiquetado automático.$\r$\n  \
													•  Crear listas de reproducción, mediante el generador$\r$\n      \
                                                                                                        automático de lista de reproducción.$\r$\n  \
...
; bundle page
${LangFileString} IDS_PAGE_BUNDLE_TITLE		"Obtenga el mejor rendimiento de $(^NameDA)"
${LangFileString} IDS_PAGE_BUNDLE_SUBTITLE	"Seleccione las siguientes funciones adicionales para sacar el máximo rendimiento de $(^NameDA)."
${LangFileString} IDS_PAGE_BUNDLE_CAPTION	"Obtenga la mejor experiencia de $(^NameDA) con todas las funciones adicionales"
${LangFileString} IDS_PAGE_BUNDLE_DLSIZE	"Tamaño:"
${LangFileString} IDS_PAGE_BUNDLE_INSTALLED	"Ya instalado"
${LangFileString} IDS_PAGE_BUNDLE_BADOS		"Sólo para Windows XP o posterior"
${LangFileString} IDS_PAGE_BUNDLE_MB		"MB"
${LangFileString} IDS_PAGE_BUNDLE_KB		"KB"

; bundles
${LangFileString} IDS_BUNDLE1_NAME		"Winamp® Remote"
;${LangFileString} IDS_BUNDLE1_DESCRIPTION	"Disfrute su música y videos al instante, transmita la música de su hogar desde Winamp.com, compatible con teléfonos móviles \
;                                                Nintendo® Wii™, Sony® PlayStation® 3 y Microsoft® Xbox™ 360."
${LangFileString} IDS_BUNDLE2_NAME		"Barra de herramientas de Winamp® (Winamp® Toolbar)"
${LangFileString} IDS_BUNDLE2_DESCRIPTION	"Controle Winamp desde su navegador Web y obtenga acceso instantaneo \
													a SHOUTcast."
${LangFileString} IDS_BUNDLE21_NAME		"Establecer Winamp® Search como mi motor de búsqueda por defecto"
${LangFileString} IDS_BUNDLE21_DESCRIPTION	"Permítale a Winamp ayudarle a buscar en la Web con Winamp® Search."
${LangFileString} IDS_WINAMP_SEARCH		"Winamp Search (Búsqueda de Winamp)"

${LangFileString} IDS_BUNDLE3_NAME		"50 descargas de MP3 gratis en eMusic +1 audiolibro"
${LangFileString} IDS_BUNDLE3_DESCRIPTION	"Pruebe gratis 2 semanas de eMusic y disfrute de 50 descargas de MP3 gratuitas +1 audiolibro. \
                                                Las descargas son suyas incluso, si cancela la suscripción."
...
;Winamp3
${LangFileString} msgWA3			"Se detectó Winamp3..."
${LangFileString} msgWA3_UPGRADE		"Se detectó Winamp3. actualizar la instalación de Winamp3 a Winamp  ${VERSION_MAJOR}.${VERSION_MINOR}${VERSION_MINOR_SECOND} y migrar las carátulas a Winamp  ${VERSION_MAJOR}.${VERSION_MINOR}${VERSION_MINOR_SECOND}?$\r$\n(Al seleccionar SI actualizará la instalación a Winamp 5.x recomendado, seleccionando NO se mantendran las instalaciones de Winamp3 y Winamp 5.x separadas)"
${LangFileString} msgWA3_MIGRATE		"Migramdo Cáratulas..."
${LangFileString} msgWA3_REMOVE			"Eliminando la instalación de Winamp3..."
${LangFileString} msgWA3_REMOVE2		"Los archivos en '$0' no fueron totalmente eliminados.$\r$\nSi desea puede eliminarlos manualmente."
...
${LangFileString} IDS_SEC_SONIC_DESC			"Biblioteca sonora, es necesaria para la grabación de CDs de audio."
...
${LangFileString} IDS_SEC_MP3_ENC_DESC			"Compatibilidad de grabación y transcodificación a formato MP3"
...
${LangFileString} IDS_SEC_ML_DESC				"Biblioteca multimedia Winamp (requerida)"
...
${LangFileString} IDS_SEC_ML_DASH_DESC			"Escritorio, página inicial opcional para la biblioteca multimedia"
...
;${LangFileString} IDS_SEC_ML_ORGLER_DESC		"Winamp Orgler™ le permite seguir, organizar y compartir el historial de la música que escucha"
${LangFileString} IDS_SEC_ML_ADDONS_DESC		"Descubra y agruegue extensiones a su Winamp con agregados (addons)"
${LangFileString} IDS_SEC_MUSIC_BUNDLE_DESC		"Descarga e instala música gratis dese Winamp Music"
...
${LangFileString} IDS_UNINSTALL_BUNDLES_GROUP_DESC		"Elija los programas relacionados con la desinstalación."
...
${LangFileString} IDS_UNINSTALL_BUNDLES_HEADER			"Los siguientes programas relacionados con Winamp se eliminarán en esta desinstalación:"
; ${LangFileString} IDS_UNINSTALL_BUNDLES_FOOTER		"Note: You can uninstall these programs at any time via Windows Control Panel."
${LangFileString} IDS_UNINSTALL_WINAMP_TOOLBAR_DESC		"Controle $(^NameDA) directamente desde su navegador web y obtenga acceso instantáneo a SHOUTcast."
${LangFileString} IDS_UNINSTALL_WINAMP_REMOTE_DESC		"Disfrute su música y videos en cualquier lugar."
${LangFileString} IDS_UNINSTALL_BROWSER_PLUGIN_DESC		"Detector de plug-ins de Winamp para Mozilla Firefox e Internet Explorer."
${LangFileString} IDS_UNINSTALL_EMUSIC_DESC				"Descarga de música, descarga de MP3, canciones MP3 desde eMusic.com"
${LangFileString} IDS_UNINSTALL_BUNDLE_TEMPLATE			"Desinstalando $2..."
${LangFileString} IDS_UNINSTALL_FEEDBACK_CHECKBOX_TEXT	"Ayudar a $(^NameDA) enviando retroalimentación"
