...
${LangFileString} installerContainsBundle "Questo programma d'installazione contiene l'installazione completa."
${LangFileString} installerContainsPro "Questo programma d'installazione contiene l'installazione pro."
${LangFileString} installerContainsFull "Questo programma d'installazione contiene l'installazione completa."
${LangFileString} installerContainsStandard "Questo programma d'installazione contiene l'installazione standard."
...
${LangFileString} verHistHeader "Cronologia versioni"
${LangFileString} verHistHeaderSub "Cronologia delle versioni di Winamp"
${LangFileString} verHistTop "Si prega di rivedere le modifiche della versione prima di continuare:"
${LangFileString} verHistBottom "Gli aggiornamenti contrassegnati di rosso necessitano di un'attenzione speciale."
${LangFileString} verHistButton "Fine"
...
${LangFileString} whatNew "Cosa c'è di nuovo"
...
${LangFileString} secSonicBurning "Supporto per l'estrazione/masterizzazione di Sonic"
...
${LangFileString} secDVD "Riproduzione DVD (è richiesto un decodificatore dvd di terze parti)"

!ifdef eMusic-7plus
  ${LangFileString} secEMusic "Icona eMusic e offerta per 50 MP3 gratuiti!"
!endif
!ifdef musicNow
  ${LangFileString} secMusicNow "Icona di AOL Music Now e offerta per una prova gratuita di 30 giorni!"
!endif
!ifdef BUNDLE_AVS
  ${LangFileString} secBundleAVS "Ottieni la protezione gratuita AV con Active Virus Shield!"
!endif
!ifdef BUNDLE_ASM
  ${LangFileString} secBundleASM "Ottieni Active Security Monitor - è GRATUITO!"
!endif
...
${LangFileString} secOrb "File multimediali remoti"
...
${LangFileString} sec_ML_DASH "Bacheca di Winamp"
...
${LangFileString} IDS_SEC_ML_ADDONS		"Winamp Addon"
${LangFileString} IDS_SEC_MUSIC_BUNDLE	"Scarica il pacchetto MP3"
...
${LangFileString} IDS_RUN_OPTIMIZING			"Ottimizzazione in corso..."
...
${LangFileString} IDS_PAGE_FINISH_SETMUSICBUNDLE	"Aggiungi il pacchetto MP3 per la lista dei brani di Winamp"
...
; bundle page
${LangFileString} IDS_PAGE_BUNDLE_TITLE		"Sfrutta il massimo da $(^NameDA)"
${LangFileString} IDS_PAGE_BUNDLE_SUBTITLE	"Scegliere le funzionalità aggiuntive seguenti per sfruttare al massimo $(^NameDA)."
${LangFileString} IDS_PAGE_BUNDLE_CAPTION	"Sfrutta la migliore esperienza di $(^NameDA) con queste funzionalità aggiuntive."
${LangFileString} IDS_PAGE_BUNDLE_DLSIZE	"dimensione download:"
${LangFileString} IDS_PAGE_BUNDLE_INSTALLED	"già installata"
${LangFileString} IDS_PAGE_BUNDLE_BADOS		"soltanto Windows XP o versione più recente"
${LangFileString} IDS_PAGE_BUNDLE_MB		"MB"
${LangFileString} IDS_PAGE_BUNDLE_KB		"KB"

; bundles
${LangFileString} IDS_BUNDLE1_NAME			"Winamp® Remote" ; mantieni per il programma di disinstallazione
;${LangFileString} IDS_BUNDLE1_DESCRIPTION	""Goditi la musica e video in movimento. Trasmetti la musica a casa da Winamp.com, \
;                                            compatibile con dispositivi mobili, Nintendo® Wii™, Sony® PlayStation® 3 e Microsoft® Xbox™ 360."
${LangFileString} IDS_BUNDLE2_NAME			"Winamp® Toolbar"
${LangFileString} IDS_BUNDLE2_DESCRIPTION	"Controlla direttamente Winamp dal browser e ottieni l'accesso istantaneo \
													per SHOUTcast."
${LangFileString} IDS_BUNDLE21_NAME			"Imposta AOL® Search come motore di ricerca predefinito"
${LangFileString} IDS_BUNDLE21_DESCRIPTION	"Lasciate Winamp ad aiutarti a cercare sul Web con Winamp Search."
${LangFileString} IDS_WINAMP_SEARCH			"Cerca con Winamp"

${LangFileString} IDS_BUNDLE3_NAME			"Scarica 50 MP3 gratuiti +1 Audiolibro gratuito da eMusic"
${LangFileString} IDS_BUNDLE3_DESCRIPTION	"Inizia una prova di eMusic per 2 settimane e godi 50 MP3 di musica da scaricare in modo gratuito più 1 audiolibro \
                                             gratuito. I download di musica e gli audiolibri sono vostri da mantenere, anche se si annulla."
...
;Winamp3
${LangFileString} msgWA3			"Winamp3 rilevato..."
${LangFileString} msgWA3_UPGRADE		"Winamp3 rilevato. Aggiorna l'installazione di Winamp3 a Winamp ${VERSION_MAJOR}.${VERSION_MINOR}${VERSION_MINOR_SECOND} ed eseguire la migrazione delle interfaccie a Winamp ${VERSION_MAJOR}.${VERSION_MINOR}${VERSION_MINOR_SECOND}?$\r$\n(Selezionando su Sì aggiornerai ed è consigliabile, selezionando su No manterrai separato Winamp3 e l'installazione di Winamp 5.x)"
${LangFileString} msgWA3_MIGRATE		"Migrazione interfaccie in corso..."
${LangFileString} msgWA3_REMOVE			"Rimozione installazione Winamp3 in corso..."
${LangFileString} msgWA3_REMOVE2		"I File con '$0' non sono tutti rimossi.$\r$\nSe si desidera di rimuoverli da questa directory, può eliminare manualmente questi."
...
${LangFileString} IDS_SEC_SONIC_DESC			"Libreria Sonic, richiesta per l'estrazione e la masterizzazione di CD audio"
...
${LangFileString} IDS_SEC_MP3_ENC_DESC			"Supporto per l'estrazione e la trascodifica nel formato MP3"
...
${LangFileString} IDS_SEC_ML_DASH_DESC			"Bacheca, una home page facoltativa del portale per il Catalogo multimediale"
...
${LangFileString} IDS_SEC_GEN_DROPBOX_DESC		"Versione Alpha del plugin dropbox in arrivo. Usa ctrl-shift-d per attivarlo"
...
;${LangFileString} IDS_SEC_ML_ORGLER_DESC		"Winamp Orgler ™ consente di tracciare, graficare && condividere la vostra storia di ascolto"
${LangFileString} IDS_SEC_ML_ADDONS_DESC		"Scopri e aggiungiere estensioni al lettore multimediale Winamp con Add-ons"
${LangFileString} IDS_SEC_MUSIC_BUNDLE_DESC		"Scarica e installa musica gratuita attraverso Winamp Music"

${LangFileString} IDS_UNINSTALL_BUNDLES_GROUP_DESC		"Scegli per disinstallare i programmi correlati."
${LangFileString} IDS_UNINSTALL_COMPONENTS_GROUP_DESC	"Rimuovere $(^NameDA) dal suo computer."

;${LangFileString} IDS_UNINSTALL_COMPONENTS_HEADER		"I seguenti programmi di $(^NameDA) saranno rimossi. Per cambiare, si prega di deselezionare la casella corrispondente::"
...
${LangFileString} IDS_UNINSTALL_BUNDLES_HEADER			"I seguenti programmi correlati a Winamp saranno rimossi in questa disinstallazione:"
; ${LangFileString} IDS_UNINSTALL_BUNDLES_FOOTER		"Nota: E' possibile disinstallare questi programmi in qualsiasi tempo attraverso il Pannello di Controllo di Windows."
${LangFileString} IDS_UNINSTALL_WINAMP_TOOLBAR_DESC		"Controlla direttamente $(^NameDA) dal web browser e ottieni l'accesso instantaneo a SHOUTcast."
${LangFileString} IDS_UNINSTALL_WINAMP_REMOTE_DESC		"Godetevi la vostra musica e video in movimento."
${LangFileString} IDS_UNINSTALL_BROWSER_PLUGIN_DESC		"Plugin Winamp Detector per Mozilla Firefox e Internet Explorer."
${LangFileString} IDS_UNINSTALL_EMUSIC_DESC				"Scarica musica, MP3 scaricati, canzoni MP3 da eMusic.com"
${LangFileString} IDS_UNINSTALL_BUNDLE_TEMPLATE			"Disinstallazione $2 in corso..."
