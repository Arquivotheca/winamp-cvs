...
${LangFileString} installStandart "標準(Std)"
...
${LangFileString} installerContainsBundle "このインストーラには全てのバンドルが含まれています。"
${LangFileString} installerContainsPro "このインストーラにはPro版が含まれています。"
${LangFileString} installerContainsFull "このインストーラには全て(Full)版が含まれています。"
${LangFileString} installerContainsStandard "このインストーラには標準(Std)版が含まれています。"
...
${LangFileString} verHistHeader "バージョン履歴"
${LangFileString} verHistHeaderSub "Winamp バージョン履歴"
${LangFileString} verHistTop "続ける前にバージョンの違いを確認してください:"
${LangFileString} verHistBottom "赤で示される最新版は、特別な注意を必要とします。"
${LangFileString} verHistButton "完了"
...
${LangFileString} secSonicBurning "Sonic リッピング/CD書き込み サポート"
...
${LangFileString} secDVD "DVD 再生 (サードパーティ製のDVDデコーダが必要です)"

!ifdef eMusic-7plus
  ${LangFileString} secEMusic "eMusic からの50曲の無料MP3ダウンロード"
!endif
!ifdef musicNow
  ${LangFileString} secMusicNow "30日間の無料試用期間付きの AOL Music Now アイコン"
!endif
!ifdef BUNDLE_AVS
  ${LangFileString} secBundleAVS "Active Virus Shield による無料のAV保護を取得"
!endif
!ifdef BUNDLE_ASM
  ${LangFileString} secBundleASM "アクティブ セキュリティ モニター - これは無料です"
!endif
...
${LangFileString} secOrb "リモート メディア"
...
${LangFileString} sec_ML_DASH "Winamp ダッシュボード"
...
;${LangFileString} IDS_SEC_ML_ORGLER		"Winamp Orgler(TM)"
${LangFileString} IDS_SEC_ML_ADDONS		"Winamp Add-ons"
${LangFileString} IDS_SEC_MUSIC_BUNDLE	"Download MP3 バンドル"
${LangFileString} IDS_SEC_GEN_FRENCHRADIO "フランスのラジオプラグイン"
${LangFileString} IDS_SEC_CLOUD       "Winamp クラウド"
...
${LangFileString} IDS_RUN_OPTIMIZING			"最適化..."
...
${LangFileString} IDS_PAGE_FINISH_SETMUSICBUNDLE	"MP3 bundle を Winamp プレイリストに追加"
...
; bundle page
${LangFileString} IDS_PAGE_BUNDLE_TITLE		"$(^NameDA) を最大限に活用してください。"
${LangFileString} IDS_PAGE_BUNDLE_SUBTITLE	"以下の追加機能を選んで、$(^NameDA) を最大限に活用してください。"
${LangFileString} IDS_PAGE_BUNDLE_CAPTION	"これらの追加機能を利用して最高の $(^NameDA) 体験をしましょう。"
${LangFileString} IDS_PAGE_BUNDLE_DLSIZE	"ダウンロードサイズ:"
${LangFileString} IDS_PAGE_BUNDLE_INSTALLED	"既にインストールされています"
${LangFileString} IDS_PAGE_BUNDLE_BADOS		"Windows XP またはそれ以降専用です"
${LangFileString} IDS_PAGE_BUNDLE_MB		"MB"
${LangFileString} IDS_PAGE_BUNDLE_KB		"KB"

; bundles
${LangFileString} IDS_BUNDLE1_NAME			"Winamp(R) リモート"	; keep for uninstaller
;${LangFileString} IDS_BUNDLE1_DESCRIPTION	"音楽とビデオを楽しみましょう。ホームミュージックを Winamp.com、\
;                                            互換性のあるモバイルデバイス、Nintendo(R) Wii(TM)、Sony(R) PlayStation(R)3 および Microsoft(R) Xbox(TM)360 からストリームしましょう。"
${LangFileString} IDS_BUNDLE2_NAME			"Winamp(R) ツールバー"
${LangFileString} IDS_BUNDLE2_DESCRIPTION	"Winamp を Web ブラウザから直接コントロールして、SHOUTcastへインスタントアクセスしましょう。"
${LangFileString} IDS_BUNDLE21_NAME			"AOL(R) Search をデフォルトの検索エンジンに設定します"
${LangFileString} IDS_BUNDLE21_DESCRIPTION	"Winamp Search で Web 検索のお手伝いをさせてください。"
${LangFileString} IDS_WINAMP_SEARCH			"Winamp Search"

${LangFileString} IDS_BUNDLE3_NAME			"eMusic 50曲無料MP3/無料オーディオブック1個のダウンロード"
${LangFileString} IDS_BUNDLE3_DESCRIPTION	"eMusic の2週間無料トライアルを利用して50曲の無料MP3と無料オーディオブック1個をダウンロードして楽しんでください。ダウンロードした曲はとオーディオブックは購入をキャンセルした場合でもそのまま手元に残ります。"
...
;Winamp3
${LangFileString} msgWA3			"Winamp3を検出..."
${LangFileString} msgWA3_UPGRADE		"Winamp3を検出しました.  Winamp ${VERSION_MAJOR}.${VERSION_MINOR}${VERSION_MINOR_SECOND} のインストール時に Winamp3 のスキンを Winamp ${VERSION_MAJOR}.${VERSION_MINOR}${VERSION_MINOR_SECOND} に引っ越しますか？$\r$\n(はいを選んでアップグレードすることを推奨します。いいえを選ぶと、インストール済みの Winamp3 とは別の設定で Winamp5.x をインストールします)"
${LangFileString} msgWA3_MIGRATE		"スキンの引っ越し..."
${LangFileString} msgWA3_REMOVE			"Winamp3の削除..."
${LangFileString} msgWA3_REMOVE2		"ファイルの '$0' は削除できませんでした。$\r$\nこのディレクトリからこれらファイルを削除したい場合は、手動で削除してください。"
...
${LangFileString} IDS_SEC_SONIC_DESC			"Sonic ライブラリ。音楽CDのリッピングと書き込みに必要です。"
...
${LangFileString} IDS_SEC_MP3_ENC_DESC			"MP3 フォーマットのリッピングおよびトランスコーディングのサポート"
...
${LangFileString} IDS_SEC_ML_DASH_DESC			"ダッシュボード。メディアライブラリ用のオプションのホームページ ポータルです。"
...
${LangFileString} IDS_SEC_GEN_DROPBOX_DESC		"来たるべきドロップボックスプラグインのアルファバージョン。起動するには Ctrl-Shift-d を使用。"
${LangFileString} IDS_SEC_ML_IMPEX_DESC			"iTunes互換メディアライブラリデータベースのインポート・エクスポートプラグイン"
;${LangFileString} IDS_SEC_ML_ORGLER_DESC		"Winamp Orgler がトラックとチャートの視聴履歴を共有します"
${LangFileString} IDS_SEC_ML_ADDONS_DESC		"Winamp メディアプライヤーと Add-on で拡張を発見して、追加してください"
${LangFileString} IDS_SEC_MUSIC_BUNDLE_DESC		"Winamp Music から無料の音楽をダウンロードして、インストールします"
${LangFileString} IDS_SEC_GEN_FRENCHRADIO_DESC	"300以上のフランスのラジオ局、$(^NameDA) の生放送 (Virgin radio, NRJ, RTL, Skyrock, RMC...)"
${LangFileString} IDS_SEC_CLOUD_DESC			"いわゆるクラウドに関して"


${LangFileString} IDS_UNINSTALL_BUNDLES_GROUP_DESC		"アンインストールする関連するプログラムを選んでください。"
${LangFileString} IDS_UNINSTALL_COMPONENTS_GROUP_DESC	"コンピューターから $(^NameDA) を取り除きます。"

;${LangFileString} IDS_UNINSTALL_COMPONENTS_HEADER		"以下の $(^NameDA) 関連プログラムは取り除かれます。変更するにはチェックを外してください。:"
...
${LangFileString} IDS_UNINSTALL_BUNDLES_HEADER			"以下の Winamp 関連プログラムがアンインストールされます:"
; ${LangFileString} IDS_UNINSTALL_BUNDLES_FOOTER		"Note: You can uninstall these programs at any time via Windows Control Panel."
${LangFileString} IDS_UNINSTALL_WINAMP_TOOLBAR_DESC		"SHOUTcast への簡易アクセスとwebブラウザからの $(^NameDA) 直接制御"
${LangFileString} IDS_UNINSTALL_WINAMP_REMOTE_DESC		"音楽とビデオを楽しんでください。"
${LangFileString} IDS_UNINSTALL_BROWSER_PLUGIN_DESC		"Mozilla Firefox と Internet Explorer の Winamp 検出プラグイン。"
${LangFileString} IDS_UNINSTALL_EMUSIC_DESC				"音楽ダウンロード、MP3ダウンロード、eMusic.com からの MP3 楽曲"
${LangFileString} IDS_UNINSTALL_BUNDLE_TEMPLATE			"$2 アンインストール中..."
