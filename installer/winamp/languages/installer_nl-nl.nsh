...
${LangFileString} installStandart 	"Standaard"
...
${LangFileString} installerContainsBundle "Dit installatieprogramma omvat de volledige bundel."
${LangFileString} installerContainsPro 	"Dit installatieprogramma omvat de Pro-versie."
${LangFileString} installerContainsFull "Dit installatieprogramma omvat de volledige versie."
${LangFileString} installerContainsStandard "Dit installatieprogramma omvat de standaardversie."
...
${LangFileString} verHistHeader 	"Versiehistorie"
${LangFileString} verHistHeaderSub 	"Versiehistorie van Winamp"
${LangFileString} verHistTop 		"Lees het overzicht met wijzigingen in de nieuwe versie door alvorens verder te gaan:"
${LangFileString} verHistBottom 	"Vooral de rood gemarkeerde updates verdienen uw aandacht."
${LangFileString} verHistButton 	"Voltooien"
...
${LangFileString} whatNew 		"Nieuw in deze versie"
...
${LangFileString} secSonicBurning 	"Ondersteuning voor Sonic rippen & branden"
...
${LangFileString} secDVD 		"DVD's afspelen (vereist een dvd-decoder van een andere leverancier)"

!ifdef eMusic-7plus
  ${LangFileString} secEMusic 		"eMusic-Icoon en Aanbieding voor 50 gratis MP3's!"
!endif
!ifdef musicNow
  ${LangFileString} secMusicNow 	"AOL Music Now-icoon en Aanbieding voor gratis proefabonnement van 30 dagen!"
!endif
!ifdef BUNDLE_AVS
  ${LangFileString} secBundleAVS 	"Profiteer van gratis bescherming tegen virussen met Active Virus Shield!"
!endif
!ifdef BUNDLE_ASM
  ${LangFileString} secBundleASM 	"Gebruik Active Security Monitor - geheel GRATIS!"
!endif
...
${LangFileString} secOrb 		"Externe Media"
${LangFileString} secWire 		"Podcast-Directory"
${LangFileString} secMagic 		"MusicID-Mix"
...
${LangFileString} IDS_SEC_MUSIC_BUNDLE		"Download MP3 Bundel"
...
${LangFileString} IDS_RUN_OPTIMIZING				"Optimaliseren..."
...
${LangFileString} IDS_PAGE_FINISH_SETMUSICBUNDLE	"Voeg MP3 bundel toe aan Winamp speellijst"
...
; bundle page
${LangFileString} IDS_PAGE_BUNDLE_TITLE		"Gebruik $(^NameDA) optimaal"
${LangFileString} IDS_PAGE_BUNDLE_SUBTITLE	"Selecteer de onderstaande extra functies om $(^NameDA) optimaal te gebruiken."
${LangFileString} IDS_PAGE_BUNDLE_CAPTION	"Haal met deze extra functies het uiterste uit $(^NameDA)."
${LangFileString} IDS_PAGE_BUNDLE_DLSIZE	"downloadgrootte:"
${LangFileString} IDS_PAGE_BUNDLE_INSTALLED	"reeds geïnstalleerd"
${LangFileString} IDS_PAGE_BUNDLE_BADOS		"alleen Windows XP of hoger"
${LangFileString} IDS_PAGE_BUNDLE_MB		"MB"
${LangFileString} IDS_PAGE_BUNDLE_KB		"KB"

; bundles
${LangFileString} IDS_BUNDLE1_NAME		"Winamp® Remote"
${LangFileString} IDS_BUNDLE1_DESCRIPTION	"Geniek ook onderweg van jouw muziek en video's. Stream jouw muziek via Winamp.com, \
                                            	compatible met mobiele telefoons, Nintendo® Wii™, Sony® PlayStation® 3 & Microsoft® Xbox™ 360."
${LangFileString} IDS_BUNDLE2_NAME		"Winamp®-werkbalk"
${LangFileString} IDS_BUNDLE2_DESCRIPTION	"Bedien Winamp direct vanuit uw webbrowser en krijg direct toegang \
													tot SHOUTcast."
${LangFileString} IDS_BUNDLE21_NAME		"Winamp® Zoeken als standaard zoekmachine gebruiken"
${LangFileString} IDS_BUNDLE21_DESCRIPTION	"Ondersteuning van Winamp bij het zoeken op het web."
${LangFileString} IDS_WINAMP_SEARCH		"Winamp Zoeken"

${LangFileString} IDS_BUNDLE3_NAME		"Download 50 gratis mp3's +1 gratis AudioBoek van eMusic"
${LangFileString} IDS_BUNDLE3_DESCRIPTION	"Neem een gratis proefabonnement van 2 weken op eMusic en download 50 gratis mp3's +1 gratis \
                                                    AudioBoek. Deze downloads mag u overigens ook houden nadat u het abonnement opzegt."
...
;Winamp3
${LangFileString} msgWA3			"Winamp3 gevonden..."
${LangFileString} msgWA3_UPGRADE		"Winamp3 gevonden. Winamp3 installatie opwaarderen naar Winamp ${VERSION_MAJOR}.${VERSION_MINOR}${VERSION_MINOR_SECOND} en de skins samenvoegen met Winamp ${VERSION_MAJOR}.${VERSION_MINOR}${VERSION_MINOR_SECOND}?$\r$\n(Ja kiezen is aanbevoelen en start de opwaardering, Nee houdt de Winamp3 installatie gescheiden van Winamp 5.x)"
${LangFileString} msgWA3_MIGRATE		"Skins samenvoegen..."
${LangFileString} msgWA3_REMOVE			"Winamp3 installatie verwijderen..."
${LangFileString} msgWA3_REMOVE2		"De bestanden in '$0' zijn niet allemaal verwijderd.$\r$\nAls je deze bestanden wilt verwijderen moet je dat handmatig doen."
...
${LangFileString} IDS_SEC_SONIC_DESC			"Sonic Library, vereist voor het rippen && branden van audio-cd's"
...
${LangFileString} IDS_SEC_MP3_ENC_DESC			"Ondersteuning voor rippen en transcoderen naar MP3-formaat"
...
${LangFileString} IDS_SEC_ML_DASH_DESC			"Dashboard, een optionele homepage-portal voor Mediabibliotheek"
...
${LangFileString} IDS_SEC_GEN_DROPBOX_DESC		"Alpha versie van de binnenkort te verwachten dropbox plugin. Toets ctrl-shift-d om te activeren"
${LangFileString} IDS_SEC_ML_IMPEX_DESC			"iTunes-compatible Media Bibliotheek database import/export plugin"
;${LangFileString} IDS_SEC_ML_ORGLER_DESC		"Winamp Orgler™, jouw luister-geschiedenis bijhouden en delen"
${LangFileString} IDS_SEC_ML_ADDONS_DESC		"Ontdek en voeg extensies toe aan Winamp met Add-ons"
${LangFileString} IDS_SEC_MUSIC_BUNDLE_DESC		"Download en installeerd gratis muziek van 'Winamp Music'"

;========================================================================================
; uninstall section

${LangFileString} IDS_UNINSTALL_BUNDLES_GROUP_DESC		"Kies welke programma's u wilt verwijderen."
${LangFileString} IDS_UNINSTALL_COMPONENTS_GROUP_DESC		"Verwijder $(^NameDA) van uw systeem."

;${LangFileString} IDS_UNINSTALL_COMPONENTS_HEADER		"De volgende $(^NameDA) gerelateerde programma's zullen worden verwijderd. Vink het bijbehorende onderdeel uit om dit te veranderen:"
...
${LangFileString} IDS_UNINSTALL_BUNDLES_HEADER			"De volgende Winamp gerelateerde programma's worden verwijderd:"
; ${LangFileString} IDS_UNINSTALL_BUNDLES_FOOTER		"NB: U kunt deze programma's op ieder moment via het Windows Configuratiescherm verwijderen."
${LangFileString} IDS_UNINSTALL_WINAMP_TOOLBAR_DESC		"Bestuur $(^NameDA) vanuit uw browser en u hebt direct toegang tot SHOUTcast."
${LangFileString} IDS_UNINSTALL_WINAMP_REMOTE_DESC		"Geniet onderweg van uw muziek en video's."
${LangFileString} IDS_UNINSTALL_BROWSER_PLUGIN_DESC		"Winamp Detectie Plug-ins voor Mozilla Firefox en Internet Explorer."
${LangFileString} IDS_UNINSTALL_EMUSIC_DESC			"Muziek Downloads, MP3 Downloads, MP3 nummers van eMusic.com"
${LangFileString} IDS_UNINSTALL_BUNDLE_TEMPLATE			"Verwijderen van $2..."
