...
${LangFileString} installerContainsBundle "Cette installation contient la version complète packagée."
${LangFileString} installerContainsPro "Cette installation contient la version profesionnelle."
${LangFileString} installerContainsFull "Cette installation contient la version complète."
${LangFileString} installerContainsStandard "Cette installation contient la version standard."
...
${LangFileString} verHistHeader "Historique des versions"
${LangFileString} verHistHeaderSub "Historique des versions de Winamp"
${LangFileString} verHistTop "Cette nouvelle version intègre les nouveautés suivantes :"
${LangFileString} verHistBottom "Les fonctionnalités indiquées en rouge requièrent une attention toute particulière."
${LangFileString} verHistButton "Finaliser"
...
${LangFileString} whatNew "Quoi de neuf ?"
...
${LangFileString} secSonicBurning "Support de l'extraction/gravure CD"
...
${LangFileString} secDVD "Lecture DVD (un décodeur DVD tiers est requis)"

!ifdef eMusic-7plus
  ${LangFileString} secEMusic "Icône eMusic et Offre pour 50 MP3 gratuits!"
!endif
!ifdef musicNow
  ${LangFileString} secMusicNow "Icône AOL Music Now et Offre pour 30 jours gratuits !"
!endif
!ifdef BUNDLE_AVS
  ${LangFileString} secBundleAVS "Protection anti-virus gratuite avec Active Virus Shield!"
!endif
!ifdef BUNDLE_ASM
  ${LangFileString} secBundleASM "Active Security Monitor - c'est GRATUIIIIT !"
!endif
...
${LangFileString} secOrb "Média distant"
...
${LangFileString} sec_ML_DASH "Tableau de bord Winamp"
...
${LangFileString} IDS_SEC_ML_ADDONS		"Suppléments Winamp"
${LangFileString} IDS_SEC_MUSIC_BUNDLE	"Télécharger le complément MP3"
...
${LangFileString} IDS_RUN_OPTIMIZING			"Optimisation..."
...
${LangFileString} IDS_PAGE_FINISH_SETMUSICBUNDLE	"Ajouter bundle MP3 à Winamp playlist"


; welcome page
${LangFileString} IDS_PAGE_WELCOME_TITLE		"Bienvenue dans le programme d'installation de $(^NameDA)"
${LangFileString} IDS_PAGE_WELCOME_TEXT		"$(^NameDA) vous permet d'écouter, de regarder et de gérer la musique, les vidéos les podcasts et les radios Internet sur vos PCs et vos périphériques multimédia. Il comprend :$\r$\n$\r$\n  \
													•  la synchronisation sans fil de vos médias vers l$\'application $(^NameDA) pour Android$\r$\n$\r$\n  \
													•  le contrôle de la lecture depuis votre navigateur avec la barre d$\'outils Winamp$\r$\n$\r$\n  \
													•  le nettoyage de vos métadonnées avec Auto-Tag$\r$\n$\r$\n  \
													•  un générateur automatique de listes de lecture personnalisées$\r$\n$\r$\n  \
													•  l$\'accès à près de 30 000 podcasts"
...
; bundle page
${LangFileString} IDS_PAGE_BUNDLE_TITLE		"Tirez un maximum de $(^NameDA)"
${LangFileString} IDS_PAGE_BUNDLE_SUBTITLE	"Choisissez les fonctionnalités supplémentaires à installer, pour tirer le maximum de $(^NameDA)."
${LangFileString} IDS_PAGE_BUNDLE_CAPTION	"Bénéficiez de la meilleure expérience possible de $(^NameDA) à travers ces fonctionnalités supplémentaires."
${LangFileString} IDS_PAGE_BUNDLE_DLSIZE	"Taille :"
${LangFileString} IDS_PAGE_BUNDLE_INSTALLED	"déjà installé"
${LangFileString} IDS_PAGE_BUNDLE_BADOS		"pour Windows XP ou supérieur"
...
;${LangFileString} IDS_BUNDLE1_DESCRIPTION	"Profitez de votre musique et de vos vidéos à votre convenance à travers l'Internet. Diffusez vos média personnels vers Winamp.com, les téléphones mobiles compatibles, \
;                                                    la Nintendo® Wii™, Sony® PlayStation® 3 et la Microsoft® Xbox™ 360."
${LangFileString} IDS_BUNDLE2_NAME			"Barre d'outils Winamp®"
${LangFileString} IDS_BUNDLE2_DESCRIPTION	"Contrôlez Winamp directement depuis votre navigateur Internet, et accédez directement \
													à SHOUTcast."
${LangFileString} IDS_BUNDLE21_NAME			"Définir Winamp® Search comme moteur de recherche par défaut"
${LangFileString} IDS_BUNDLE21_DESCRIPTION	"Laissez Winamp vous aider dans vos recherches sur l'Internet."
${LangFileString} IDS_WINAMP_SEARCH			"Winamp Search"

${LangFileString} IDS_BUNDLE3_NAME			"50 MP3 et 1 livre audio à télécharger depuis eMusic"
${LangFileString} IDS_BUNDLE3_DESCRIPTION	"Testez gratuitement pour deux semaines eMusic, et profitez de 50 musiques MP3 à téléchargement gratuitement, ainsi que d'un livre audio. \
                                                    Ces morceaux seront à vous, même si vous arrêtez."
...
;Winamp3
${LangFileString} msgWA3			"Winamp3 a été détecté..."
${LangFileString} msgWA3_UPGRADE		"Winamp3 a été détecté. Voulez-vous mettre à jour et migrer les skins de Winamp3 vers Winamp ${VERSION_MAJOR}.${VERSION_MINOR}${VERSION_MINOR_SECOND} ?$\r$\nSélectionnez Oui pour lancer la mise à jour (recommandé). Sélectionnez Non pour garder des installations distincte de Winamp3 et de Winamp 5.x."
${LangFileString} msgWA3_MIGRATE		"Migration des skins..."
${LangFileString} msgWA3_REMOVE			"Suppression de l'installation de Winamp3..."
${LangFileString} msgWA3_REMOVE2		"Les fichiers dans '$0' n'ont pas pu être tous supprimés.$\r$\nSi vous le souhaitez, vous pouvez maintenant supprimer manuellement les fichiers de ce répertoire."
...
${LangFileString} IDS_SEC_SONIC_DESC			"Bibliothèque Sonic, requise pour l'extraction && la gravure des CD Audio"
...
${LangFileString} IDS_SEC_MP3_ENC_DESC			"Support de l'extraction et de la conversion vers le format MP3"
...
${LangFileString} IDS_SEC_ML_DASH_DESC			"Portail d'accueil optionnel pour la Médiathèque"
...
${LangFileString} IDS_SEC_GEN_DROPBOX_DESC		"Version alpha du plugin dropbox, bientôt sur vos écrans... Utilisez Ctrl-MAJ-D pour l'activer"
${LangFileString} IDS_SEC_ML_IMPEX_DESC			"Plugin d'importation/explortation d'une médiathèque compatible iTunes"
;${LangFileString} IDS_SEC_ML_ORGLER_DESC		"Winamp Orgler™ vous permet de pister et partager votre historique de lecture"
${LangFileString} IDS_SEC_ML_ADDONS_DESC		"Découvrez et ajoutez des extensions à votre lecteur multimédia Winamp avec les suppléments"
${LangFileString} IDS_SEC_MUSIC_BUNDLE_DESC		"Téléchargez et installez de la musique gratuitement depuis Winamp Music"
...
${LangFileString} IDS_SEC_CLOUD_DESC			"Ce cloud machin, tout le monde en parle"


${LangFileString} IDS_UNINSTALL_BUNDLES_GROUP_DESC		"Veuillez sélectionner les programmes associés à désinstaller."
${LangFileString} IDS_UNINSTALL_COMPONENTS_GROUP_DESC	"Désinstalle $(^NameDA) de votre ordinateur."

;${LangFileString} IDS_UNINSTALL_COMPONENTS_HEADER		"Les programmes suivants, associés à $(^NameDA), seront désinstallés. Pour l'éviter, veuillez décocher les cases correspondantes :"
...
${LangFileString} IDS_UNINSTALL_BUNDLES_HEADER			"Les programmes suivants, associés à Winamp, seront désinstallés :"
; ${LangFileString} IDS_UNINSTALL_BUNDLES_FOOTER			"Note : Vous pouvez supprimer ces programes à tout moment à travers le Panneau de Configuration de Windows."
${LangFileString} IDS_UNINSTALL_WINAMP_TOOLBAR_DESC		"Contrôlez $(^NameDA) directement depuis votre navigateur et accédez directement à SHOUTcast."
${LangFileString} IDS_UNINSTALL_WINAMP_REMOTE_DESC		"Profitez de vos musiques et vidéos sur l'instant."
${LangFileString} IDS_UNINSTALL_BROWSER_PLUGIN_DESC		"Détecteur de plugins Winamp pour Mozilla Firefox et Internet Explorer."
${LangFileString} IDS_UNINSTALL_EMUSIC_DESC				"Téléchargements de musiques et mp3 depuis eMusic.com"
${LangFileString} IDS_UNINSTALL_BUNDLE_TEMPLATE			"Désinstallation de '$2'..."
