...
${LangFileString} installerContainsBundle "Full 번들 설치를 포함합니다."
${LangFileString} installerContainsPro "Pro 설치를 포함합니다."
${LangFileString} installerContainsFull "Full 설치를 포함합니다."
${LangFileString} installerContainsStandard "Standard 설치를 설치합니다."
...
${LangFileString} verHistHeader "버전 내역"
${LangFileString} verHistHeaderSub "Winamp 버전 내역"
${LangFileString} verHistTop "계속하기 전에 버전 변경사항을 검토하십시오."
${LangFileString} verHistBottom "빨간색으로 표시된 업데이트는 특히 주의해야 합니다."
${LangFileString} verHistButton "마침"
...
${LangFileString} secSonicBurning "음향 변환/굽기 지원"
...
${LangFileString} secDVD "DVD 재생(타사 DVD 디코더 필수)"

!ifdef eMusic-7plus
  ${LangFileString} secEMusic "eMusic 아이콘 및 50개의 MP3 파일을 무료로 제공!"
!endif
!ifdef musicNow
  ${LangFileString} secMusicNow "AOL Music Now 아이콘 및 30일 무료 평가판 제공!"
!endif
!ifdef BUNDLE_AVS
  ${LangFileString} secBundleAVS "Active Virus Shield로 무료 AV 보호를 받으세요!"
!endif
!ifdef BUNDLE_ASM
  ${LangFileString} secBundleASM "Active Security Monitor 다운로드 - 무료입니다!"
!endif
...
${LangFileString} secOrb "원격 미디어"
${LangFileString} secWire "팟캐스트 디렉터리"
${LangFileString} secMagic "MusicIP 믹스"
...
${LangFileString} sec_ML_DASH "Winamp 대시보드"
...
; bundle page
${LangFileString} IDS_PAGE_BUNDLE_TITLE		"대부분의 $(^NameDA) 가져오기"
${LangFileString} IDS_PAGE_BUNDLE_SUBTITLE	"아래 추가 기능을 선택하여 대부분의 $(^NameDA)을(를) 가져오십시오."
${LangFileString} IDS_PAGE_BUNDLE_CAPTION	"이 추가 기능을 통해 최고의 $(^NameDA)을(를) 만나보십시오."
${LangFileString} IDS_PAGE_BUNDLE_DLSIZE	"다운로드 크기:"
${LangFileString} IDS_PAGE_BUNDLE_INSTALLED	"이미 설치됨"
${LangFileString} IDS_PAGE_BUNDLE_BADOS		"Windows XP 이후 버전만"

; bundles
${LangFileString} IDS_BUNDLE1_NAME			"Winamp® Remote"
${LangFileString} IDS_BUNDLE1_DESCRIPTION	"원할 때 언제든지 음악 및 동영상을 즐길 수 있습니다. Winamp.com, 호환 가능한 모바일 장치, \
                                            Nintendo® Wii™, Sony® PlayStation® 3 및 Microsoft® Xbox™ 360에서 홈 뮤직을 스트리밍합니다."
${LangFileString} IDS_BUNDLE2_NAME			"Winamp® 도구 모음"
${LangFileString} IDS_BUNDLE2_DESCRIPTION	"웹 브라우저에서 직접 Winamp를 제어하고 SHOUTcast에 즉시 \
													액세스합니다."
${LangFileString} IDS_BUNDLE21_NAME			"Winamp® Search를 내 기본 검색 엔진으로 설정"
${LangFileString} IDS_BUNDLE21_DESCRIPTION	"Winamp Search로 웹 검색을 지원할 수 있습니다."
${LangFileString} IDS_WINAMP_SEARCH			"Winamp Search"

${LangFileString} IDS_BUNDLE3_NAME			"eMusic에서 50개의 MP3 파일 무료 다운로드"
${LangFileString} IDS_BUNDLE3_DESCRIPTION	"eMusic 2주 무료 평가판을 사용하고 50곡의 MP3 파일을 무료로 다운로드할 수 있습니다. \
                                                    취소하더라도 다운로드한 파일은 저장됩니다."
...
${LangFileString} IDS_SEC_SONIC_DESC			"Sonic 라이브러리(오디오 CD를 변환하고 구울 때 필요) "
...
${LangFileString} IDS_SEC_MP3_ENC_DESC			"MP3 형식으로 변환 및 트랜스코딩 지원"
...
${LangFileString} IDS_SEC_ML_DASH_DESC			"대시보드(미디어 라이브러리에 대한 선택적 홈 페이지 포털)"
...
${LangFileString} IDS_SEC_ML_ORB_DESC			"Winamp Remote(모든 원격 PC 또는 네트워크에서 미디어 라이브러리에 액세스)"
