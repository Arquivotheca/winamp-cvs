...
${LangFileString} installStandart "标准"
...
${LangFileString} installerContainsBundle "此安装程序包含完全捆绑安装。"
${LangFileString} installerContainsPro "此安装程序包含 Pro 安装。"
${LangFileString} installerContainsFull "此安装程序包含完全安装。"
${LangFileString} installerContainsStandard "此安装程序包含标准安装。"
...
${LangFileString} verHistHeader "版本历史"
${LangFileString} verHistHeaderSub "Winamp 版本历史"
${LangFileString} verHistTop "请在继续之前查看版本更改:"
${LangFileString} verHistBottom "需要特别注意标记为红色的更新。"
${LangFileString} verHistButton "完成"
...
${LangFileString} secSonicBurning "Sonic 翻录/刻录支持"
...
${LangFileString} secDVD "DVD 播放(需要第三方 DVD 解码器)"

!ifdef eMusic-7plus
  ${LangFileString} secEMusic "为 50 首免费 MP3 提供 eMusic 图标和优惠!"
!endif
!ifdef musicNow
  ${LangFileString} secMusicNow "免费试用 30 天的 AOL Music Now 图标和优惠!"
!endif
!ifdef BUNDLE_AVS
  ${LangFileString} secBundleAVS "使用 Active Virus Shield 获取免费的病毒防护!"
!endif
!ifdef BUNDLE_ASM
  ${LangFileString} secBundleASM "获取 Active Security Monitor – 免费!"
!endif
...
${LangFileString} secOrb "远程媒体"
${LangFileString} secWire "播客目录"
${LangFileString} secMagic "MusicIP 混合"
...
${LangFileString} sec_ML_DASH "Winamp 仪表板"
...
; bundle page
${LangFileString} IDS_PAGE_BUNDLE_TITLE		"充分利用 $(^NameDA)"
${LangFileString} IDS_PAGE_BUNDLE_SUBTITLE	"选择下面的附加功能以充分利用 $(^NameDA)。"
${LangFileString} IDS_PAGE_BUNDLE_CAPTION	"使用这些附加功能来获得最佳 $(^NameDA) 体验。"
${LangFileString} IDS_PAGE_BUNDLE_DLSIZE	"下载大小:"
${LangFileString} IDS_PAGE_BUNDLE_INSTALLED	"已安装"
${LangFileString} IDS_PAGE_BUNDLE_BADOS		"仅限 Windows XP 或更高版本"

; bundles
${LangFileString} IDS_BUNDLE1_NAME			"Winamp® Remote"
${LangFileString} IDS_BUNDLE1_DESCRIPTION	"在您到处走动时欣赏音乐和视频。从 Winamp.com、\
兼容移动设备、Nintendo® Wii™、Sony® PlayStation® 3 和 Microsoft® Xbox™ 360 流式播放您的家庭音乐。"
${LangFileString} IDS_BUNDLE2_NAME			"Winamp® 工具栏"
${LangFileString} IDS_BUNDLE2_DESCRIPTION	"直接从您的 Web 浏览器控制 Winamp 以及即时访问 \
													SHOUTcast。"
${LangFileString} IDS_BUNDLE21_NAME			"将 Winamp® 搜索设置为默认搜索引擎"
${LangFileString} IDS_BUNDLE21_DESCRIPTION	"使用 Winamp 搜索让 Winamp 帮助您搜索 Web"
${LangFileString} IDS_WINAMP_SEARCH			"Winamp 搜索"

${LangFileString} IDS_BUNDLE3_NAME			"eMusic 的 50 首免费 MP3 下载"
${LangFileString} IDS_BUNDLE3_DESCRIPTION	"开始 eMusic 为期 2 周的免费试用，享用 50 首免费 MP3 音乐下载。 \
这些下载会为您保留，即使您取消也是如此。"
...
${LangFileString} IDS_SEC_SONIC_DESC			"Sonic 库，翻录和刻录音频 CD 所必需的"
...
${LangFileString} IDS_SEC_MP3_ENC_DESC			"支持翻录和代码转换为 MP3 格式"
...
${LangFileString} IDS_SEC_ML_DASH_DESC			"仪表板，媒体库的一个可选主页门户"
...
${LangFileString} IDS_SEC_ML_ORB_DESC			"Winamp Remote，用于从任何远程 PC 或网络访问您的媒体库"
