...
${LangFileString} installStandart "Standard 版"
...
${LangFileString} installerContainsBundle "這個安裝程式可安裝完整套裝版軟體。"
${LangFileString} installerContainsPro "這個安裝程式可安裝專業版軟體。"
${LangFileString} installerContainsFull "這個安裝程式可安裝完整版軟體。"
${LangFileString} installerContainsStandard "這個安裝程式可安裝標準版軟體。"
...
${LangFileString} verHistHeader "版本歷程記錄"
${LangFileString} verHistHeaderSub "Winamp 版本歷程記錄"
${LangFileString} verHistTop "請先瞭解版本變更內容，再繼續進行："
${LangFileString} verHistBottom "請特別注意標示為紅色的更新。"
...
${LangFileString} secSonicBurning "支援 Sonic 擷取/燒錄"
...
${LangFileString} secDVD "DVD 播放 (需要協力廠商 DVD 解碼器)"

!ifdef eMusic-7plus
  ${LangFileString} secEMusic "eMusic 圖示和 50 首免費的 MP3!"
!endif
!ifdef musicNow
  ${LangFileString} secMusicNow "AOL Music Now 圖示和 30 天免費試用!"
!endif
!ifdef BUNDLE_AVS
  ${LangFileString} secBundleAVS "取得 Active Virus Shield 免費 AV 防護!"
!endif
!ifdef BUNDLE_ASM
  ${LangFileString} secBundleASM "免費取得 Active Security Monitor!"
!endif
...
${LangFileString} sec_ML_DASH "Winamp 儀表板"
...
; bundle page
${LangFileString} IDS_PAGE_BUNDLE_TITLE		"充分使用 $(^NameDA)"
${LangFileString} IDS_PAGE_BUNDLE_SUBTITLE	"選擇下列額外功能以充分使用 $(^NameDA)。"
${LangFileString} IDS_PAGE_BUNDLE_CAPTION	"透過這些額外功能體驗最佳的 $(^NameDA)。"
${LangFileString} IDS_PAGE_BUNDLE_DLSIZE	"下載大小："
${LangFileString} IDS_PAGE_BUNDLE_INSTALLED	"已下載"
${LangFileString} IDS_PAGE_BUNDLE_BADOS		"僅適用 Windows XP 或更高版本"

; bundles
${LangFileString} IDS_BUNDLE1_NAME			"Winamp® Remote"
${LangFileString} IDS_BUNDLE1_DESCRIPTION	"隨時隨地享受音樂與影像。可自 Winamp.com、 \
相容之隨身裝置、Nintendo® Wii™、Sony® PlayStation® 3 及 Microsoft® Xbox™ 360 取得音樂供您在家欣賞。"
${LangFileString} IDS_BUNDLE2_NAME			"Winamp® 工具列"
${LangFileString} IDS_BUNDLE2_DESCRIPTION	"可自您的網路瀏覽器直接控制 Winamp 並即時存取 \
													SHOUTcast。"
${LangFileString} IDS_BUNDLE21_NAME			"將 Winamp® 搜尋設為我的預設搜尋引擎"
${LangFileString} IDS_BUNDLE21_DESCRIPTION	"讓 Winamp 透過 Winamp 搜尋協助您搜尋網路。"
${LangFileString} IDS_WINAMP_SEARCH			"Winamp 搜尋"

${LangFileString} IDS_BUNDLE3_NAME			"50 首 eMusic 免費 MP3 下載"
${LangFileString} IDS_BUNDLE3_DESCRIPTION	"開始 eMusic 兩週試用版並享受 50 首免費 MP3 音樂下載。 \
即使取消，您仍可保有下載的音樂。"
...
${LangFileString} IDS_SEC_SONIC_DESC			"Sonic 程式庫，擷取與錄製音效 CD 必備功能"
...
${LangFileString} IDS_SEC_MP3_ENC_DESC			"支援擷取與轉碼至 MP3 格式"
...
${LangFileString} IDS_SEC_ML_DASH_DESC			"儀表板，可選之媒體櫃入口首頁"
...
${LangFileString} IDS_SEC_ML_ORB_DESC			"Winamp Remote，可從任何遠距個人電腦或網絡存取媒體櫃"
