...
${LangFileString} installerContainsBundle "Installationsprogrammet innehåller den fullständiga paketinstallationen."
${LangFileString} installerContainsPro "Installationsprogrammet innehåller installationen av Winamp Pro."
${LangFileString} installerContainsFull "Installationsprogrammet innehåller den fullständiga installationen."
${LangFileString} installerContainsStandard "Installationsprogrammet innehåller standardinstallationen."
...
${LangFileString} verHistHeader "Versionshistorik"
${LangFileString} verHistHeaderSub "Versionshistorik för Winamp"
${LangFileString} verHistTop "Gå igenom versionsförändringar innan du fortsätter:"
${LangFileString} verHistBottom "Var särskilt uppmärksam på uppdateringar markerade med rött."
${LangFileString} verHistButton "Slutför"
...
${LangFileString} whatNew "Nyheter"
...
${LangFileString} secSonicBurning "Stöd för Sonic-rippning/bränning"
...
${LangFileString} secDVD "Uppspelning av DVD (DVD-avkodare från en tredje part krävs)"

!ifdef eMusic-7plus
  ${LangFileString} secEMusic "eMusic-ikon och erbjudande om 50 gratis MP3-filer!"
!endif
!ifdef musicNow
  ${LangFileString} secMusicNow "AOL Music Now-ikon och erbjudande om att prova gratis i 30 dagar!"
!endif
!ifdef BUNDLE_AVS
  ${LangFileString} secBundleAVS "Få gratis antivirusskydd med Active Virus Shield."
!endif
!ifdef BUNDLE_ASM
  ${LangFileString} secBundleASM "Hämta Active Security Monitor – det är gratis!"
!endif
...
${LangFileString} secOrb "Fjärrmedia"
...
${LangFileString} sec_ML_DASH "Winamp-instrumentpanel"
...
; bundle page
${LangFileString} IDS_PAGE_BUNDLE_TITLE		"Utnyttja hela potentialen hos $(^NameDA)"
${LangFileString} IDS_PAGE_BUNDLE_SUBTITLE	"Välj ytterligare funktioner nedan för att utnyttja hela potentialen hos $(^NameDA)."
${LangFileString} IDS_PAGE_BUNDLE_CAPTION	"Upplev hela potentialen hos $(^NameDA) genom dessa extra funktioner."
${LangFileString} IDS_PAGE_BUNDLE_DLSIZE	"storlek på hämtningspaket:"
${LangFileString} IDS_PAGE_BUNDLE_INSTALLED	"redan installerat"
${LangFileString} IDS_PAGE_BUNDLE_BADOS		"endast Windows XP eller senare"
${LangFileString} IDS_PAGE_BUNDLE_MB		"MB"
${LangFileString} IDS_PAGE_BUNDLE_KB		"KB"

; bundles
${LangFileString} IDS_BUNDLE1_NAME			"Winamp® Remote"
${LangFileString} IDS_BUNDLE1_DESCRIPTION	"Spela upp låtar och videofilmer var du än är via webben, kompatibla mobiltelefoner\
                                                    eller spelkonsoler som Nintendo® Wii™, Sony® PlayStation® 3 och Microsoft® Xbox™. \
                                                    ${BUNDLE1_NAME} strömmar musik och videofilmer över Internet och hjälper dig att \
                                                    dela media med dina vänner."
${LangFileString} IDS_BUNDLE2_NAME			"Winamp® -verktygsfältet"
${LangFileString} IDS_BUNDLE2_DESCRIPTION	"Styr Winamp direkt från webbläsaren och få direkttillgång \
													till SHOUTcast."
${LangFileString} IDS_BUNDLE3_NAME			"Hämta 50 MP3-låtar från eMusic utan kostnad"
${LangFileString} IDS_BUNDLE3_DESCRIPTION	"Starta en gratis 2-veckors provperiod på eMusic och hämta 50 MP3-låtar utan kostnad. \
                                                    Du får behålla de hämtade filerna även om du inte fortsätter."
...
${LangFileString} IDS_SEC_SONIC_DESC			"Sonic Library, nödvändigt för rippning och bränning av ljud-CD-skivor"
...
${LangFileString} IDS_SEC_MP3_ENC_DESC			"Stöd för rippning och omkodning till MP3-format"
...
${LangFileString} IDS_SEC_ML_DASH_DESC			"Instrumentpanelen är en alternativ portal för mediebiblioteket"
...
${LangFileString} IDS_SEC_ML_ORB_DESC			"Winamp Remote ger dig möjlighet att nå ditt mediebibliotek via fjärranslutning från en dator eller ett nätverk"
