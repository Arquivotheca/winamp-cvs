...
${LangFileString} verHistTop "Veuillez parcourir les nouveautés avant de continuer :"
${LangFileString} verHistBottom "Les mises à jour indiquées en rouge requierent une attention toute particulière."
${LangFileString} verHistButton "Terminer"
...
; bundle page
${LangFileString} IDS_PAGE_BUNDLE_TITLE		"Tirez-en un maximum de $(^NameDA)"
${LangFileString} IDS_PAGE_BUNDLE_SUBTITLE	"Choisissez les fonctionnalités supplémentaires à installer, pour en tirer un maximum de $(^NameDA)."
...
; bundles
${LangFileString} IDS_BUNDLE1_NAME			"Winamp® Distant"
${LangFileString} IDS_BUNDLE1_DESCRIPTION	"Profitez de votre musique et de vos vidéos à votre convenance à travers l'Internet, depuis les téléphones mobiles compatibles \
                                                    et les consoles de jeux vidéo comme la Nintendo® Wii™, Sony® PlayStation® 3 et la Microsoft® Xbox™. \
                                                    Partagez avec vos amis vos musiques et vidéos personnelles à travers l'Internet."
...
${LangFileString} IDS_BUNDLE2_DESCRIPTION	"Contrôlez Winamp directement depuis votre navigateur Internet, et accédez directement \
													à SHOUTcast."
${LangFileString} IDS_BUNDLE3_NAME			"50 MP3 à télécharger gratuitement depuis eMusic"
${LangFileString} IDS_BUNDLE3_DESCRIPTION	"Testez gratuitement pour deux semaines eMusic, et profitez de 50 musiques MP3 à téléchargement gratuitement. \
...
${LangFileString} IDS_SEC_ML_ORB_DESC			"Winamp Distant, pour l'accès à votre médiathèque depuis n'importe quel autre ordinateur"
