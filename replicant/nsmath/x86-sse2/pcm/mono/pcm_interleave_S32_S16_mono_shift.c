...
static __declspec(naked) void Convert_S32_S16_mono_shift_Unaligned(int16_t *destination_buffer, const int32_t **source_buffer, size_t channels, size_t count_per_channel, unsigned int decimation_bits)
{
	/*  general structure 
...
void x86_SSE2_nsmath_pcm_Convert_S32_S16_mono_decimate(int16_t *destination, const int32_t **source, size_t channels, size_t count_per_channel, unsigned int decimation_bits)
{
	...
	{
		Convert_S32_S16_mono_shift_Unaligned(destination, source, channels, count_per_channel, decimation_bits);
	}
