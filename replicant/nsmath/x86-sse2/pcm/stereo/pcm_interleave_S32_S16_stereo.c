...
static __declspec(naked) void Convert_S32_S16_stereo_Aligned_12(int16_t *destination_buffer, const int32_t **source_buffer, size_t channels, size_t count_per_channel)
{
	/*  general structure 
...
static __declspec(naked) void Convert_S32_S16_stereo_AlignedSource_12(int16_t *destination_buffer, const int32_t **source_buffer, size_t channels, size_t count_per_channel)
{
	/*  general structure 
		movss/shufps to load gain into xmm7
		movaps source_left (int32) into xmm0
...
static __declspec(naked) void Convert_S32_S16_stereo_AlignedDestination_12(int16_t *destination_buffer, const int32_t **source_buffer, size_t channels, size_t count_per_channel)
{
	/*  general structure 
		movss/shufps to load gain into xmm7
		movaps source_left (int32) into xmm0
...
static __declspec(naked) void Convert_S32_S16_stereo_Unaligned_12(int16_t *destination_buffer, const int32_t **source_buffer, size_t channels, size_t count_per_channel)
{
	/*  general structure 
		movss/shufps to load gain into xmm7
		movaps source_left (int32) into xmm0
...
void x86_SSE2_nsmath_pcm_Convert_S32_S16_stereo(int16_t *destination, const int32_t **source, size_t channels, size_t count_per_channel)
{
	...
	{
		Convert_S32_S16_stereo_Aligned_12(destination, source, channels, count_per_channel);
	}
	else if (source_aligned)
	{
		Convert_S32_S16_stereo_AlignedSource_12(destination, source, channels, count_per_channel);
	}
	else if (destination_aligned)
	{
		Convert_S32_S16_stereo_AlignedDestination_12(destination, source, channels, count_per_channel);
	}
	else
	{
		Convert_S32_S16_stereo_Unaligned_12(destination, source, channels, count_per_channel);
	}
}
