...
static __declspec(naked) void Convert_S32_S16_gain_stereo_Aligned_12(int16_t *destination_buffer, const int32_t **source_buffer, size_t channels, size_t count_per_channel, float gain)
{
	/*  general structure 
...
static __declspec(naked) void Convert_S32_S16_gain_stereo_AlignedSource_8(int16_t *destination_buffer, const int32_t **source_buffer, size_t channels, size_t count_per_channel, float gain)
{
	/*  general structure 
		movss/shufps to load gain into xmm7
		movaps source_left (int32) into xmm0
...
loop1:
		...
		punpckldq xmm0, xmm1 // mm1 holds [L R]
...
static __declspec(naked) void Convert_S32_S16_gain_stereo_AlignedDestination_12(int16_t *destination_buffer, const int32_t **source_buffer, size_t channels, size_t count_per_channel, float gain)
{
	/*  general structure 
		movss/shufps to load gain into xmm7
		movaps source_left (int32) into xmm0
...
static __declspec(naked) void Convert_S32_S16_gain_stereo_Unaligned_12(int16_t *destination_buffer, const int32_t **source_buffer, size_t channels, size_t count_per_channel, float gain)
{
	/*  general structure 
		movss/shufps to load gain into xmm7
		movaps source_left (int32) into xmm0
...
void x86_SSE2_nsmath_pcm_Convert_S32_S16_gain_stereo(int16_t *destination, const int32_t **source, size_t channels, size_t count_per_channel, float gain)
{
	...
	{
		Convert_S32_S16_gain_stereo_Aligned_12(destination, source, channels, count_per_channel, gain);
	}
	else if (source_aligned)
	{
		Convert_S32_S16_gain_stereo_AlignedSource_8(destination, source, channels, count_per_channel, gain);
	}
	else if (destination_aligned)
	{
		Convert_S32_S16_gain_stereo_AlignedDestination_12(destination, source, channels, count_per_channel, gain);
	}
	else
	{
		Convert_S32_S16_gain_stereo_Unaligned_12(destination, source, channels, count_per_channel, gain);
	}
}
